...
NES_mapper::NES_mapper(NES* parent) : parent_NES(parent)
{
  ...
  VROM_tiles = parent_NES->ROM->get_VROM_tiles();
...
*/
  ...
  parent_NES->cpu->Set_CPU_banks(ROM_banks + (bank4_num << 13),
	  ROM_banks + (bank5_num << 13),
	  ROM_banks + (bank6_num << 13),
	  ROM_banks + (bank7_num << 13));
...
void NES_mapper::set_CPU_bank4(uint32 bank_num)
{
  ...
  parent_NES->cpu->SetContext(&context);
  */
  parent_NES->cpu->Set_CPU_bank(4, ROM_banks + (bank_num << 13));
...
void NES_mapper::set_CPU_bank5(uint32 bank_num)
{
  ...
  parent_NES->cpu->SetContext(&context);
  */
  parent_NES->cpu->Set_CPU_bank(5, ROM_banks + (bank_num << 13));
  set_genie();
}
...
void NES_mapper::set_CPU_bank6(uint32 bank_num)
{
  ...
  parent_NES->cpu->SetContext(&context);
  */
  parent_NES->cpu->Set_CPU_bank(6, ROM_banks + (bank_num << 13));
  set_genie();
}
...
void NES_mapper::set_CPU_bank7(uint32 bank_num)
{
  ...
  parent_NES->cpu->SetContext(&context); */
  parent_NES->cpu->Set_CPU_bank(7, ROM_banks + (bank_num << 13));
  set_genie();
}
                               ...
                               uint32 bank6_num, uint32 bank7_num)
{
  ...
  parent_NES->cpu->SetContext(&context);
  */
  parent_NES->cpu->Set_CPU_banks(ROM_banks + (bank3_num << 13),
	  ROM_banks + (bank4_num << 13),
	  ROM_banks + (bank5_num << 13),
	  ROM_banks + (bank6_num << 13),
	  ROM_banks + (bank7_num << 13));
  set_genie();
...
void NES_mapper::set_CPU_bank3(uint32 bank_num)
{
  ...
  parent_NES->cpu->SetContext(&context);
  */
  parent_NES->cpu->Set_CPU_bank(3, ROM_banks + (bank_num << 13));
}
//////////////////////////////////////////////////////////////////////////
                               ...
                               uint32 bank6_num, uint32 bank7_num)
{
  ...
  /*
  parent_NES->ppu->PPU_tile_banks[0] = VROM_tiles + bank0_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  parent_NES->ppu->PPU_tile_banks[1] = VROM_tiles + bank1_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  parent_NES->ppu->PPU_tile_banks[2] = VROM_tiles + bank2_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  parent_NES->ppu->PPU_tile_banks[3] = VROM_tiles + bank3_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  parent_NES->ppu->PPU_tile_banks[4] = VROM_tiles + bank4_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  parent_NES->ppu->PPU_tile_banks[5] = VROM_tiles + bank5_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  parent_NES->ppu->PPU_tile_banks[6] = VROM_tiles + bank6_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  parent_NES->ppu->PPU_tile_banks[7] = VROM_tiles + bank7_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  */
  parent_NES->ppu->set_tile_banks(VROM_tiles + bank0_num * 0x400 / 16 * BYTES_PER_MERGED_TILE,
      VROM_tiles + bank1_num * 0x400 / 16 * BYTES_PER_MERGED_TILE,
      VROM_tiles + bank2_num * 0x400 / 16 * BYTES_PER_MERGED_TILE,
      VROM_tiles + bank3_num * 0x400 / 16 * BYTES_PER_MERGED_TILE,
      VROM_tiles + bank4_num * 0x400 / 16 * BYTES_PER_MERGED_TILE,
      VROM_tiles + bank5_num * 0x400 / 16 * BYTES_PER_MERGED_TILE,
      VROM_tiles + bank6_num * 0x400 / 16 * BYTES_PER_MERGED_TILE,
      VROM_tiles + bank7_num * 0x400 / 16 * BYTES_PER_MERGED_TILE);
}
...
void NES_mapper::set_PPU_bank0(uint32 bank_num)
{
  ...
  //parent_NES->ppu->PPU_tile_banks[0] = VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  parent_NES->ppu->set_tile_bank(0, VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE);
}
...
void NES_mapper::set_PPU_bank1(uint32 bank_num)
{
  ...
  //parent_NES->ppu->PPU_tile_banks[1] = VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  parent_NES->ppu->set_tile_bank(1, VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE);
}
...
void NES_mapper::set_PPU_bank2(uint32 bank_num)
{
  ...
  //parent_NES->ppu->PPU_tile_banks[2] = VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  parent_NES->ppu->set_tile_bank(2, VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE);
}
...
void NES_mapper::set_PPU_bank3(uint32 bank_num)
{
  ...
  //parent_NES->ppu->PPU_tile_banks[3] = VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  parent_NES->ppu->set_tile_bank(3, VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE);
}
...
void NES_mapper::set_PPU_bank4(uint32 bank_num)
{
  ...
  //parent_NES->ppu->PPU_tile_banks[4] = VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  parent_NES->ppu->set_tile_bank(4, VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE);
}
...
void NES_mapper::set_PPU_bank5(uint32 bank_num)
{
  ...
  //parent_NES->ppu->PPU_tile_banks[5] = VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  parent_NES->ppu->set_tile_bank(5, VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE);
}
...
void NES_mapper::set_PPU_bank6(uint32 bank_num)
{
  ...
  //parent_NES->ppu->PPU_tile_banks[6] = VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  parent_NES->ppu->set_tile_bank(6, VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE);
}
...
void NES_mapper::set_PPU_bank7(uint32 bank_num)
{
  ...
  //parent_NES->ppu->PPU_tile_banks[7] = VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE;
  parent_NES->ppu->set_tile_bank(7, VROM_tiles + bank_num * 0x400 / 16 * BYTES_PER_MERGED_TILE);
}
...
void NES_mapper::set_PPU_bank8(uint32 bank_num)
{
  ...
  parent_NES->ppu->set_name_table(8, VROM_banks + (bank_num << 10));
}
void NES_mapper::set_PPU_bank9(uint32 bank_num)
{
  VALIDATE_VROM_BANK(bank_num);
  //parent_NES->ppu->PPU_VRAM_banks[9] = VROM_banks + (bank_num << 10);
  parent_NES->ppu->set_name_table(9, VROM_banks + (bank_num << 10));
}
void NES_mapper::set_PPU_bank10(uint32 bank_num)
{
  VALIDATE_VROM_BANK(bank_num);
  //parent_NES->ppu->PPU_VRAM_banks[10] = VROM_banks + (bank_num << 10);
  parent_NES->ppu->set_name_table(10, VROM_banks + (bank_num << 10));
}
void NES_mapper::set_PPU_bank11(uint32 bank_num)
{
  VALIDATE_VROM_BANK(bank_num);
  //parent_NES->ppu->PPU_VRAM_banks[11] = VROM_banks + (bank_num << 10);
  parent_NES->ppu->set_name_table(11, VROM_banks + (bank_num << 10));
}

// for mapper 1,4,5,6,13,19,80,85,96,119
void NES_mapper::set_VRAM_bank(uint32 bank, uint32 bank_num)
{
	NES_PPU *ppu = parent_NES->ppu;
	if(bank < 8) {
		//ppu->PPU_VRAM_banks[bank] = ppu->get_patt() + ((bank_num & 0x0f) << 10);
		ppu->set_pattype(bank, 0);
		// Rick
		ppu->set_VRAM_bank(bank, bank_num);
	} else if(bank < 12) {
		// ppu->PPU_VRAM_banks[bank] = ppu->get_namt() + ((bank_num & 0x03) << 10);
		// Rick
		ppu->set_name_table(bank, bank_num);
	}
}
