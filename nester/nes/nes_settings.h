...
*/
/* $Id: nes_settings.h,v 1.4 2003/10/28 12:57:18 Rick Exp $ */
...
public:
  ...
  void SetDefaults()
  {
	...
	// Rick
	force_pal = FALSE;
	priority = PRI_NORMAL;	// PRI_NORMAL is enough :)
    //priority = PRI_HIGH;
